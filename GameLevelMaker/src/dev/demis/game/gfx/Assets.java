...
public class Assets {
	...
	public static BufferedImage[] editorBtn;
	public static BufferedImage[] editorItemBtn;
	...
	public static void init() {
		...
		editorBtn = new BufferedImage[2];
		editorBtn[0] = ImageLoader.loadImage("/textures/editorBarButton.png");
		editorBtn[1] = ImageLoader.loadImage("/textures/editorBarButton2.png");
		editorItemBtn = new BufferedImage[2];
		editorItemBtn[0] = ImageLoader.loadImage("/textures/editorBarButtonSelection.png");
		editorItemBtn[1] = ImageLoader.loadImage("/textures/editorBarButtonSelection2.png");

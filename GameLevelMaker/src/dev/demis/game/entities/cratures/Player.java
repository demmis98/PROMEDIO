...
public class Player extends Creature {
	...
	public void tick() {
		...
		for(Entity e : handler.getWorld().getEntityManager().getEntities()) {
			if(e.getCollisionBounds(handler.getGameCamera().getxOffset(), handler.getGameCamera().getyOffset()).contains(handler.getMouseManager().getMouseX(), handler.getMouseManager().getMouseY())) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.mouse, (int)x, (int)y, null);
	}
